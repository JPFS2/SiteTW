    ...
    public static function getProdutoCombo()
    {
        ...
        while ($combo = $combos->fetchObject()) {
            ...
            while ($item = $itens->fetchObject()) {
                ...
                $prodtos .= $item->quantidade . '- ' . $item->descricao . ' ' . '<a href="https://juninhodoiphone.com/controle/admin/removeprodutocombo/'
                    . $item->codprodutocombo . '"><i class="fa fa-trash text-danger"></i></a>' . ' | ';
            }
