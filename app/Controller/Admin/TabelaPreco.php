...
class Tabelapreco extends Page {
    ...
    public static function insereTabelaprecosItens($request,$id,$acao){
        ...
        header("Location: https://juninhodoiphone.com/comgelo/admin/tabelapreco/$id/edit");
        die();
    }
    ...
    public static function deleteTabelaprecoiten($request,$id){
        ...
        header("Location: https://juninhodoiphone.com/controle/admin/tabelapreco/$id/edit");
        die();
