...

{
    ...
    public function cadastrar(){
        ...
        $this->dtexclusao = Date('Y-m-d H:i');

        $obDatabase = new Database('pedidos_excluidos');
    ...
    public static function buscarItensProdutos($where = null, $order = null, $limit = null, $filds = '*'){
     ...
     public static function buscarex($where = null, $order = null, $limit = null, $filds = '*')
    {
        return (new Database('pedidos_excluidos'))->selectJoin($where, $order, $limit, $filds,'cadcliente', 'pedidos_excluidos.codcli = cadcliente.codcli');
    }
