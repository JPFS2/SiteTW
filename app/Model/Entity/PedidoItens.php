...

{
    ...
    public function cadastrarExclusao(){
        ...
        $obDatabase = new Database('pedidositens_excluidos');
        $id = $obDatabase->insert([
            'numped' => $this->numped,
            'codprod' => $this->codprod,
            'qt' => $this->qt,
    ...
    public static function busca($where = null, $order = null, $limit = null, $filds = '*'){
        return  (new Database('pedidoitens'))->select($where,$order,$limit,$filds);
    }
