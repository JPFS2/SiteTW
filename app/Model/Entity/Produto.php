...
class Produto
{
    ...
    public static function atualizaCusto($codprod,$custo)
    {
        $obDatabase = new Database('cadprod');
        $success = $obDatabase->update('codprod =' . $codprod, [
                'pcusto' => $custo,
    ...
    public static function atualizaCompra($codprod,$custo)
    {
        $obDatabase = new Database('cadprod');
        $success = $obDatabase->update('codprod =' . $codprod, [
                'pcompra' => $custo,
    ...
    public static function ImportaProduto($where = null, $order = null, $limit = null, $filds = 'DISTINCT dtimport')
    {
        return (new Database('cadprod'))->select($where, $order, $limit, $filds);
    }
